...
<header id="header" class="container mt-2">
    <h6>
        <a href="index.php" title="На главную!"><?= $_SESSION['username'] ?></a>
        <span class="float-right">
            <a href="new.php" title="Добавить новую сумку!"><i class="fas fa-plus-square"></i></a>
            <a href="#" title="Изменить данные профиля <?= $_SESSION['username'] ?>"><i class="fas fa-pen-square"></i></a>
